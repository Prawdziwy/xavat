...
<table border="0" cellspacing="0" cellpadding="0" id="iblue" width="100%"><tr><td>

<TABLE BGCOLOR='.$config['site']['darkborder'].' BORDER=0 CELLPADDING=4 CELLSPACING=0 id="iblue" width="100%">
<TR BGCOLOR='.$config['site']['vdarkborder'].'><TD CLASS=white COLSPAN=5><B>Experience Table</B></TD></TR>
<TR><TD>
<TABLE BORDER=0 CELLPADDING=3 CELLSPACING=1 WIDTH=124>
